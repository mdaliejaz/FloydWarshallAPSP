				...
				int currSize)
{
	...
	else
	{
		//1. CFW (X11, U11, V11) 
			...
			{
	                	DFW(xRowStart,xColStart, uRowStart,uColStart, vRowStart,vColStart, currSize/2);
	                }
               		//2. CFW (X12, U11, V12)                                                        
               		//#pragma omp section
 			 #pragma omp task firstprivate(xRowStart,xColStart, uRowStart,uColStart, vRowStart,vColStart,currSize) 
 			 {
	                	DFW(xRowStart,xColStart + currSize/2, uRowStart,uColStart, vRowStart,vColStart + currSize/2, currSize/2);
	                }
			//3. CFW (X21, U21, V11)
			//#pragma omp section
			 #pragma omp task firstprivate(xRowStart,xColStart, uRowStart,uColStart, vRowStart,vColStart,currSize) 				
			{
	                	DFW(xRowStart + currSize/2,xColStart, uRowStart + currSize/2,uColStart, vRowStart,vColStart, currSize/2);
	                }
               		//4. CFW (X22, U21, V12)                        
               		//#pragma omp section
			 #pragma omp task firstprivate(xRowStart,xColStart, uRowStart,uColStart, vRowStart,vColStart,currSize) 
		...
		//}
			...
			//#pragma omp section
			 ...
			 #pragma omp task firstprivate(xRowStart,xColStart, uRowStart,uColStart, vRowStart,vColStart,currSize) 	
			 {	                
        	        	DFW(xRowStart + currSize/2,xColStart, uRowStart + currSize/2,uColStart + currSize/2, vRowStart + currSize/2,vColStart, currSize/2);
        	        }
			//8. CFW (X22, U22, V22)
			//#pragma omp section
			 #pragma omp task firstprivate(xRowStart,xColStart, uRowStart,uColStart, vRowStart,vColStart,currSize) 		
